...
function Featured(props) {
  return (
    <div className="w-full min-h-screen py-6 xl:py-20 bg-[#f1f1f1] rounded-t-3xl">
      <h1
        className={`pt-10 text-[30px] md:text-50px] xl:${props.textsize} px-5 xl:px-14 w-[90%] leading-[40px] md:leading-[65px] font-["Mate"] font-semibold`}
      >
        {props.text}
      </h1>
      <div
      ...
      ></div>
      <div className="px-2 xl:px-2 py-5 xl:py-20 ">
