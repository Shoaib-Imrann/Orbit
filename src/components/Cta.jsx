...
function Cta() {
  return (
    <div className="eyes w-full pt-20 rounded-t-xl z-50 relative lg:h-[115vh] ">
      <div
        data-scroll
        data-scroll-speed=".4"
        className={`relative w-full h-fit lg:w-full lg:h-full`}
      >
        <div className="flex flex-col bg-[#212121] gap-5 rounded-xl h-[60vh] sm:h-screen lg:h-[135vh] items-center justify-evenly w-full px-5 md:px-20 pb-20 pt-20 uppercase font-semibold ">
